# shared-utilities/sql/mysql_repository.py
import logging
...
class MySQLRepository:
    """
    MySQL CRUD repository - ONLY handles CRUD operations.
    Requires MySQLSyncClient for connections.
    """
    ...
    def create(self, data: Dict[str, Any]) -> int:
        ...
        return self.client.execute_insert(query, tuple(data.values()))
